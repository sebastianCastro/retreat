...
const OneDaySeaRetreat = () => (
  <div className="min-h-screen pt-0 bg-background relative" style={{ backgroundImage: "url('/retreat/images/background1.jpg')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundAttachment: 'fixed' }}>
    ...
    <div className="relative z-10">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center">
        <div 
          ...
          style={{ backgroundImage: "url('/retreat/images/leaves.jpg')" }}
        >
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-0 max-w-5xl">
        <div className="bg-nature-beige/30 rounded-lg p-6 mb-8">
          ...
          <div className="flex overflow-x-auto gap-6 mb-4 pb-4 scrollbar-thin scrollbar-thumb-nature-beige/50">
            <img src="/retreat/images/oneday3.jpg" alt="Ретрит фото 1" className="rounded-2xl shadow-lg w-[350px] h-[480px] object-cover flex-shrink-0" />
            <img src="/retreat/images/oneday4.jpg" alt="Ретрит фото 2" className="rounded-2xl shadow-lg w-[350px] h-[480px] object-cover flex-shrink-0" />
            <img src="/retreat/images/oneday5.jpg" alt="Ретрит фото 3" className="rounded-2xl shadow-lg w-[350px] h-[480px] object-cover flex-shrink-0" />
            <img src="/retreat/images/oneday1.jpg" alt="Ретрит фото 4" className="rounded-2xl shadow-lg w-[350px] h-[480px] object-cover flex-shrink-0" />
            <img src="/retreat/images/oneday2.jpg" alt="Ретрит фото 5" className="rounded-2xl shadow-lg w-[350px] h-[480px] object-cover flex-shrink-0" />
            <img src="/retreat/images/oneday.jpg" alt="Ретрит фото 6" className="rounded-2xl shadow-lg w-[350px] h-[480px] object-cover flex-shrink-0" />
            <img src="/retreat/images/oneday7.jpg" alt="Ретрит фото 7" className="rounded-2xl shadow-lg w-[350px] h-[480px] object-cover flex-shrink-0" />
            <img src="/retreat/images/oneday6.jpg" alt="Ретрит фото 8" className="rounded-2xl shadow-lg w-[350px] h-[480px] object-cover flex-shrink-0" />
            <img src="/retreat/images/oneday8.jpg" alt="Ретрит фото 9" className="rounded-2xl shadow-lg w-[350px] h-[480px] object-cover flex-shrink-0" />
            <img src="/retreat/images/oneday9.jpg" alt="Ретрит фото 10" className="rounded-2xl shadow-lg w-[350px] h-[480px] object-cover flex-shrink-0" />
          </div>
        </div>
      </section>
